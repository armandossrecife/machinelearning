...
def ploat_subcategorias(titulo, tamanho):
...
def ploata_status_projetos(titulo):
...
ploat_subcategorias('Subcategorias ds Campanhas do Kickstarter', 15)
print("Gera gráfico: Detalhamento dos status dos projetos")
ploata_status_projetos('Detalhamento dos status dos projetos')
