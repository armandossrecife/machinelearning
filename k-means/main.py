...
def backer_pledge_plot(df, dc):
    ...
    plt.xlabel("Backers")
    plt.ylabel("Dinheiro dado em dolares")
...
def backer_pledge_plot_k(df, dc, indexes_dict):
    ...
    plt.xlabel("Objetivo em dolares")
    plt.ylabel("Dinheiro dado em dolares")
...
if __name__ == '__main__':
    ...
    try:
        if len(sys.argv) == 2:
            ...
            df_tdata = tdata
            tdata = tdata.values
            print("Gerando o gráfico do Elbow Method...")
            elbow(tdata) # Para ver o grafico bonito
            print("Gráfico Elbow Method gerado")
            k = 4
            print("Processamento dos Clusters")
            ...
            print("Gerando gráfico Backers x Pledge...")
            backer_pledge_plot(data, state_dict)
            print("Gráfico gerado")
            print("Gerando gráfico K Backers x Pledge")
